...
class CheckInAlarmReceiver : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        CoroutineScope(Dispatchers.IO).launch {
            try {
                ...
                // Check if check-in already done today (use diaryEntries correctly)
                ...
                // Fallback: show notification anyway just in case it was a network error
                showNotification(context)
            } finally {
    ...
    private fun showNotification(context: Context) {
        ...
        val builder = NotificationCompat.Builder(context, NotificationUtils.CHANNEL_REMINDERS)
            .setSmallIcon(R.drawable.icono_plano2) // Placeholder until sun image is provided
